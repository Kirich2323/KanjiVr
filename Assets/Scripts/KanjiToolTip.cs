...
public class KanjiToolTip : MonoBehaviour {
    ...
    protected virtual void Awake() {
        VRTK.VRTK_SDKManager.AttemptAddBehaviourToToggleOnLoadedSetupChange(this);
    }

    protected virtual void OnEnable() {
        LineRenderer render = gameObject.GetComponentInChildren<LineRenderer>();
    ...
    protected virtual void OnDestroy() {
        VRTK.VRTK_SDKManager.AttemptRemoveBehaviourToToggleOnLoadedSetupChange(this);
    }
    ...
    protected virtual void SetContainer() {
        transform.Find("TooltipCanvas").GetComponent<RectTransform>().sizeDelta = new Vector2(fontSize * displayText.Length, fontSize * 1.5f);
        Transform tmpContainer = transform.Find("TooltipCanvas/UIContainer");
        tmpContainer.GetComponent<RectTransform>().sizeDelta = new Vector2(fontSize * displayText.Length, fontSize * 1.5f);
